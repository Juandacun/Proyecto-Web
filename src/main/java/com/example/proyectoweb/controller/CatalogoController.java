...
public class CatalogoController {
    ...
    public record Filtro(String categoria, String ubicacion, String tipo, String estado) {}

    @GetMapping("/catalogo")
    public String catalogo(@RequestParam(name = "categoria", required = false) String categoria,
        ...
        model.addAttribute("filtro", new Filtro(categoria, ubicacion, tipo, estado));
